...
export class GameWebSocket {
  ...
  /** Set the signing function for signature-based reconnection. */
  setSignFunction(fn: (message: string) => Promise<string>): void {
    this.signMessage = fn;
  }
  ...
  private doConnect(): Promise<void> {
    return new Promise((resolve, reject) => {
      const url = `${this.wsBaseUrl}/ws/game/${this.matchId}`;
